...
| **External integrations** | Auth0 custom DB bridge, inbound webhooks, **Sleek CMS** (SDK + config pipeline)                                                                                        | [external-integrations/README.md](./external-integrations/README.md) |
