...
| **External integrations** | Auth0 custom DB bridge, inbound webhooks, **Sleek CMS** (SDK + config pipeline), **Sleek Mailer** (transactional email service)                                                                                        | [external-integrations/README.md](./external-integrations/README.md) |
