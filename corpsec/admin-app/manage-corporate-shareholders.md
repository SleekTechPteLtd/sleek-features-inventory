...
|--------|-------|
| **Domain** | Corpsec |
| **Feature Name** | Manage Corporate Shareholders |
| **Canonical Owner** | TBD |
| **Primary User / Actor** | Corpsec Officer |
| **Business Outcome** | Maintain the register of corporate entity shareholders for regulatory compliance |
| **Entry Point / Surface** | Admin App > Company Overview > People & Entities tab |
| **Short Description** | Section: Company's Corporate Shareholders with Expand All and Add Corporate Shareholder actions. |
