# Manage Corporate Trust Shareholders
...
|--------|-------|
| **Domain** | Corpsec |
| **Feature Name** | Manage Corporate Trust Shareholders |
| **Canonical Owner** | TBD |
| **Primary User / Actor** | Corpsec Officer |
| **Business Outcome** | Record corporate entities holding shares via a trust structure, as required under Australian corporate law |
| **Entry Point / Surface** | Admin App > Company Overview > People & Entities tab – Corporate Trust Shareholders section |
| **Short Description** | AU-only entity type. Add and manage corporate trust shareholders. Supports AU trust structures not applicable in SG, HK, or UK. |
| **Variants / Markets** | AU |
